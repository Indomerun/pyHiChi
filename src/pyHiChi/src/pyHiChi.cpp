...
PYBIND11_MODULE(pyHiChi, object) {
    ...
    py::class_<Scalar_Fast_QED_Analytical>(object, "Fast_QED_Analytical")
        ...
        .def("count_integral_particle", &Scalar_Fast_QED_Analytical::countIntegralParticle, py::arg("chi"))
        .def("photon_generator", &Scalar_Fast_QED_Analytical::Photon_Generator_test, py::arg("r"), py::arg("chi"))
        .def("count_integral_photon", &Scalar_Fast_QED_Analytical::countIntegralPhoton, py::arg("chi"))
        .def("pair_generator", &Scalar_Fast_QED_Analytical::Pair_Generator_test, py::arg("r"), py::arg("chi"))
